...
function FileUpload() {
  ...
  const props = {
    ...
    accept: "image/*,application/pdf,video/*,audio/*,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/zip,application/x-zip-compressed,text/plain,text/markdown",
  };
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto", background: "#fff", borderRadius: "8px", boxShadow: "0 4px 12px rgba(0,0,0,0.08)" }}>
      <Title level={2} style={{ marginBottom: "24px", textAlign: "center", color: "#1890ff" }}>
      ...
      >
        <Dragger 
          ...
          style={{ 
            borderRadius: "8px",
            background: uploadLoading ? "#f0f5ff" : "#fafafa",
            transition: "all 0.3s ease"
          }}
        >
          <div style={{ padding: "32px 16px" }}>
            {uploadLoading ? (
              <LoadingOutlined style={{ fontSize: "48px", color: "#1890ff", marginBottom: "16px" }} spin />
            ) : (
            ...
            <Paragraph type="secondary" style={{ marginBottom: "8px" }}>
              รองรับไฟล์รูปภาพ, เอกสาร (PDF, Word, Excel, PowerPoint), วิดีโอ, เสียง และไฟล์ซิป
            </Paragraph>
            {uploadLoading && (
              <div style={{ width: "80%", margin: "16px auto" }}>
                ...
                <div style={{ textAlign: "center", marginTop: "8px", color: "#1890ff" }}>
                  {uploadProgress}% อัพโหลด...
                </div>
              </div>
            )}
          </div>
